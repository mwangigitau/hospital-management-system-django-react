"""
Base Django settings for HMS project.
"""
import os
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Comprehensive HMS REST API',
    'VERSION': '1.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'adt', 'description': 'Admission, Discharge, Transfer'},
        {'name': 'appointments', 'description': 'Appointment management'},
        {'name': 'clinical', 'description': 'Clinical consultations'},
        {'name': 'nursing', 'description': 'Nursing records'},
