...
from .views import DrugViewSet, DrugBatchViewSet, StockMovementViewSet, PrescriptionItemViewSet, barcode_scan
...
urlpatterns = [
    path('barcode-scan/', barcode_scan, name='pharmacy-barcode-scan'),
